...
<!-- Bootstrap core CSS -->
<link href="<?=SERV_URL ?>dist/css/bootstrap.min.css?v=<?=VERSION ?>"
	rel="stylesheet">
...
<link href="<?=SERV_URL ?>dist/css/dashboard.css?v=<?=VERSION ?>"
	rel="stylesheet">
...
<script type="text/javascript" src="https://cdn.datatables.net/v/bs/dt-1.10.16/fh-3.1.3/sl-1.2.5/datatables.min.js"></script>
		...
		<div class="container-fluid">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-right">
					...
					?>"><span
							class="flaticon-home168"></span> Panoramica</a></li>
					...
					<li <?=($CONTROLLER=="dotazioni" ? 'class="active"' : '') ?>><a class="desk_hide"
								href="<?=SERV_URL ?>dotazioni"><span class="glyphicon glyphicon-hdd"></span>
									Dotazioni</a></li>
					<li><a href="<?=SERV_URL ?>utenti/logout"><span
							class="flaticon-powerbuttons"></span> Logout</a></li>
				</ul>
			</div>
		</div>
	</nav>
		...
		<div class="row">
			<div class="col-sm-3 col-md-1 sidebar">
				<ul class="nav nav-sidebar">
					<li <?=($CONTROLLER=="panoramica" ? 'class="active"' : '') ?>><a
						href="<?=SERV_URL ?><?php 
    					if(isset($_SESSION['filtro_cliente']) && $_SESSION['filtro_cliente']!="")
    					    echo 'panoramica/index/'.$_SESSION['filtro_cliente'];
	          ...
	          <ul class="nav nav-sidebar">
							...
							<li <?=($CONTROLLER=="rapportinator" ? 'class="active"' : '') ?>><a
								href="<?=SERV_URL ?>rapportinator"><span class="glyphicon glyphicon-save-file"></span>
									Rapportinator</a></li>
			...
			<ul class="nav nav-sidebar">
						<li <?=($CONTROLLER=="calendario" ? 'class="active"' : '') ?>><a
								href="<?=SERV_URL ?>calendario"><span class="glyphicon glyphicon-calendar"></span>
									Calendari</a></li>
						<li <?=($CONTROLLER=="progetto" ? 'class="active"' : '') ?>><a
								href="<?=SERV_URL ?>progetto"><span class="glyphicon glyphicon-tasks"></span>
									Progetti</a></li>
						<li <?=($CONTROLLER=="team" ? 'class="active"' : '') ?>><a
								href="<?=SERV_URL ?>team"><span class="glyphicon glyphicon-knight"></span>
									Team</a></li>
						<?php if(getMyUsername()=="dchiarello" or getMyUsername()=="mbrianda" or getMyUsername()=="sleoni") { ?>
							<li <?=($CONTROLLER=="turni" ? 'class="active"' : '') ?>><a
									href="<?=SERV_URL ?>turni"><span class="glyphicon glyphicon-retweet"></span>
										Turni</a></li>
						<?php } ?> 
			</ul>
			<ul class="nav nav-sidebar">
							...
							<li <?=($CONTROLLER=="dotazioni" ? 'class="active"' : '') ?>><a
								href="<?=SERV_URL ?>dotazioni"><span class="glyphicon glyphicon-hdd"></span>
									Dotazioni</a></li>
